...
Source0  : https://sg.danny.cz/sg/p/sg3_utils-1.47.tar.xz
...
%prep
%setup -q -n sg3_utils-1.47
cd %{_builddir}/sg3_utils-1.47
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672201295
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libsgutils2-1.47.so.2
/usr/lib64/libsgutils2-1.47.so.2.0.0
